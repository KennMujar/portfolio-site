...
const projectDetails = {
  dipcy: {
    ...
    features: [
      "Accurate, localized information delivery using RAG",
      "Interactive and context-aware chat interface",
      "Predefined slash commands for quick access (/explain, /howto)",
      "Response references and citations for transparency",
      "Personalized chat experience (customizable tone)",
      "User feedback and improvement loop",
    ],
    challenges: [
      "Implementing Retrieval-Augmented Generation (RAG) to mitigate LLM hallucinations and ensure localized accuracy.",
      "Developing effective prompt engineering techniques to ground the chatbot in the provided local data.",
      "Building a reliable ingestion pipeline for processing and vectorizing diverse document types (PDFs, text).",
      "Ensuring the system can handle errors gracefully and maintain reliability during user queries.",
    ],
    impact: [
      "Validated by 20 participants in a formal acceptance test.",
      "90% of users agreed the system provides correct results and output.",
      "85% of users confirmed the system meets functional requirements.",
      "85% of users found the system user-friendly and easy to operate.",
    ],
